...
import me.tonyduco.soundripp.R;
...
public class ScanFragment extends Fragment {
    ...
    public void startScan(File path, boolean restrictDbUpdate, Context context) {
        mApplicationContext = context;
        Log.d("SoundRipp", "Scan started...");
        mHasStarted = true;
    ...
    class PreprocessTask extends AsyncTask<ScanParameters, ProgressUpdate, Void> {
        ...
        protected Void doInBackground(ScanParameters... parameters) {
            try {
                Log.d("SoundRipp", "Trying recursive...");
                recursiveAddFiles(parameters[0].getPath(), parameters[0]);
                Log.d("SoundRipp", "Tried recursive...");
            }
            catch (IOException Ex) {
                // Do nothing.
            }
    ...
    class Updater implements Runnable {
        ...
        public void run() {
            ...
            if (progress == 100) {
                ...
                Log.d("SoundRipp", "Path scanned " + mPathScanned);
